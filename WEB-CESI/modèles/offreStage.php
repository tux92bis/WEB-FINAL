...
class OffreStage
{
    ...
    {
        $sql = "INSERT INTO OffreStage (titre, description, date_debut, date_fin, type, base_remuneration) 
                VALUES (:titre, :description, :date_debut, :date_fin, :type, :base_remuneration)";
